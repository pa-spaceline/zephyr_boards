 ...
 *
 * Same Winbond W25Q64JVXGIM 8MB flash chip and config as the upstream
 * "teensy41" board (same physical Teensy 4.1 module) - refer to that
 * board's boards/pjrc/teensy4/flexspi_nor_config.c, and to hal_nxp's
 * board file this was originally derived from.
 *
